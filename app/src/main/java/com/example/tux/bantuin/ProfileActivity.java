...
public class ProfileActivity extends AppCompatActivity {
    ...
    public static final String USER_ID = "com.example.tux.bantuin.userid";
    public static final String REQUEST_NAME = "com.example.tux.bantuin.requestname";
    public static final String REQUEST_ID = "com.example.tux.bantuin.requestid";
    public static final String REQUEST_PHONE = "com.example.tux.bantuin.requestphone";
    public static final String REQUEST_KEAHLIAN = "com.example.tux.bantuin.requestkeahlian";
    public static final String REQUEST_ADDRESS = "com.example.tux.bantuin.requestaddress";
    public static final String REQUEST_EMAIL = "com.example.tux.bantuin.requestemail";
    public static final String transaction = "com.example.tux.bantuin.transaction";
    public static final String titles = "com.example.tux.bantuin.titles";
    public static final String RATING = "com.example.tux.bantuin.rating";
