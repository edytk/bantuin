...
public class DetailUserActivity extends AppCompatActivity {
    ...
    public static final String test = "com.example.tux.bantuin.titles";
    public static final String test2 = "com.example.tux.bantuin.titless";
    public static final String ID= "com.example.tux.bantuin.id ";
    public static final String FULLNAME = "com.example.tux.bantuin.fullname";
    public static final String EMAIL = "com.example.tux.bantuin.email";
    public static final String PHONE = "com.example.tux.bantuin.phone";
    public static final String PASSWORD = "com.example.tux.bantuin.password";
    public static final String STATUS = "com.example.tux.bantuin.status";
    public static final String SKILL = "com.example.tux.bantuin.skill";
    @Override
