...
public class TransactionActivity extends AppCompatActivity {
    ...
    public static final String CHAT_ROOM_ID= "com.example.tux.bantuin.chats";
    public static final String ASK= "com.example.tux.bantuin.ASKS";
    public static final String GIVE= "com.example.tux.bantuin.GIVES";
    @Override
